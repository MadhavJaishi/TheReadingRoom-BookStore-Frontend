...
const UpdateBook = () => {
    ...
    try {
        ...
        if (Object.values(Data).some(value => value === "")) {
            ...
            const response = await axios.put("https://thereadingroom-bookstore.onrender.com/api/v1/update-book", Data, {headers});
    ...
    <div className='bg-zinc-900 h-[100%] p-0 md:p-4'>
        ...
        <div className='p-4 bg-zinc-800 rounded'>
            ...
            <div className='mt-4'>
                ...
                <input type="text" className='w-full mt-2 bg-zinc-900 text-zinc-100 p-2 outline-none' placeholder='genre of book' name="genre" required value={Data.genre} onChange={change} />
            </div>
            ...
            <div className='mt-4'>
                ...
                <textarea type="text" className='w-full mt-2 bg-zinc-900 text-zinc-100 p-2 outline-none' rows="5" placeholder='description of book' name="desc" required value={Data.desc} onChange={change} />
            </div>
            <button onClick={submit} className='mt-4 px-3 bg-blue-500 text-white font-semibold py-2 rounded hover:bg-blue-600 transition-all duration-300'>Update Book</button>
        </div>
    </div>
  )
}
